...
var TEMPLATE_COMMON = 'var angular = require(\'angular\');\n' +
    'exports.default = angular.module(\'%s\', []).run(function($templateCache) {\n' +
    '  debugger;\n' +
    '  $templateCache.put(\'%s\',\n    \'%s\');\n' +
    '});\n';
...
var createHtml2JsPreprocessor = function(logger, basePath, config) {
  ...
  return function(content, file, done) {
    ...
    if (moduleName) {
      ...
      done(util.format(TEMPLATE_COMMON, htmlPath, htmlPath, escapeContent(content)));
    }
  };
};
